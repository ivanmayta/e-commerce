...
function Button({
    ...
    return (
        <button
            onClick={onClick}
            className={cn(
                "cursor-pointer bg-white font-medium text-sm py-1 text-black w-full mt-auto rounded-sm flex items-center justify-around hover:bg-gray-50 transition-colors duration-200",
                className
            )}
        >
